            ...
            {is_our_products
              ? productdata.map((data, index) => (
                  ...
                  >
                    ...
                    >
                      <span className="uppercase text-[7.876px]  tracking-[0.15em] md:mb-1 mb-1 text-[#999999]">
                        {data.categ_id ? data.categ_id[1] : "NO Category"}
                      </span>
                      <h4 className="uppercase text-[0.6875rem] text-[#cccccc] tracking-[0.15em] line-clamp-1 md:line-clamp-none">
                        {data.name}
                      </h4>
                      <p
              ...
              : visibleProducts.map((data, index) => (
                  ...
                  >
                    ...
                    <div className="pt-[25px] flex flex-col gap-[5px] py-[20px] px-[10px] shadow-[inset_0px_-1px_9px_0px_#80808057] rounded-b-[8px] md:p-0 md:pt-6 md:shadow-none md:rounded-none">
                      ...
                      <h4 className="uppercase text-[9.625px] text-black tracking-[0.15em] line-clamp-1 md:line-clamp-none">
                        {data.name}
                      </h4>
                      <p
                        className="text-[11.375px] md:text-[11.375px] text-[#999999] line-clamp-3 md:line-clamp-none break-words "
                        dangerouslySetInnerHTML={{ __html: data.description }}
                      />
                    </div>
                  </div>
            ...
            : visibleCount < productdata.length && (
                <div className="text-center md:mt-10 mt-0">
                  <button
                    ...
                    className="uppercase text-[9.625px] tracking-[0.15em] px-6 py-2 bg-transparent text-black border border-black rounded-none hover:bg-black hover:text-white transition-all cursor-pointer md:mt-3 mt-0"
                  >
                    ALLE MARKEN ANSEHEN
                  </button>
                </div>
